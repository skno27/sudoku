...
class Grid:
    # perhaps we can replace this with A gpt called the returns a new board list??
    # or give the user a collection of boards to choose from?
    ...
    def click(self, pos):
        ...
        :return: (row, col)
        """
        # check if the click is ACTUALLY within the bounds of the board
